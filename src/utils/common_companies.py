...
_FINAL_PROJECT = _REPO_ROOT.parent
...
intraday_symbols = get_symbols(_FINAL_PROJECT / "NEPSE_API/data/intraday")
interday_symbols = get_symbols(_FINAL_PROJECT / "NepseScraper/data/company-wise")
intraday_test_symbols = get_symbols(_FINAL_PROJECT / "nepse_floorsheet/data/intraday_testing")
